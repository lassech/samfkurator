    ...
    for (let n = 0; n < tab_runs; n++) {
      setTimeout(function () {
        ...
        if (ext_manifest_version === 2) {
          ...
          if (matchUrlDomain(['businesspost.ie', 'hbr.org', 'la-croix.com', 'lepoint.fr', 'ouest-france.fr', 'thehindu.com', 'thehindubusinessline.com'].concat(grouped_sites['###_fr_groupe_ebra']), url))
            script_world = "MAIN";
